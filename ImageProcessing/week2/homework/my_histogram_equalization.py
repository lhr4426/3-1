...
# 파일 접근에 이상이 있어서 os 라이브러리 import 했습니다
import os
...
if __name__ == '__main__':
    ...
    # 위에서 언급한 파일 접근 이상 해결 부분입니다
    # ---
    file_name = os.path.join(os.path.dirname(__file__), 'fruits_div3.jpg')
